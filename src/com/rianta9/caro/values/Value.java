...
public class Value {
	...
	/**
	 * Độ sâu tìm kiếm cho từng mức độ khó
	 */
	public static final int EASY_DEPTH = 2;      // Tăng từ 1 lên 2
	public static final int MEDIUM_DEPTH = 3;    // Tăng từ 2 lên 3
	public static final int HARD_DEPTH = 4;      // Tăng từ 3 lên 4
	public static final int EXPERT_DEPTH = 5;    // Tăng từ 3 lên 5
	
	/**
	 * Số lượng ô tối ưu cho từng mức độ khó
	 */
	public static final int EASY_CELL_LIST = 3;      // Tăng từ 2 lên 3
	public static final int MEDIUM_CELL_LIST = 5;    // Tăng từ 4 lên 5
	public static final int HARD_CELL_LIST = 8;      // Tăng từ 6 lên 8
	public static final int EXPERT_CELL_LIST = 12;   // Tăng từ 8 lên 12
	
	/**
	 * Mức độ khó mặc định
	 */
	public static final int DEFAULT_DIFFICULTY = DIFFICULTY_MEDIUM;
	
	/**
	 * Giá trị cho kết quả hòa
	 */
